...
<script type="text/javascript" src="{$smarty.const.ROOT_HTTP_PATH}/js/tiny_mce/tiny_mce.js"></script>
{literal} 
                  ...
                  <td width="100%"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr>
                        <td class="admin_bdr"><table width="1000" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td width="10" align="left" valign="top"><img src="{$smarty.const.ROOT_HTTP_PATH}/images/admin_images/topnav_left.gif" alt="" width="10" height="39" /></td>
                              <td width="980" class="topnav_bg"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                                  <tr>
                                    ...
                                    {if !$loginSuccess}<a href="{$smarty.const.ROOT_HTTP_PATH}/admin/logout.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('logout','','{$smarty.const.ROOT_HTTP_PATH}/images/admin_images/bttn_logout_hov.gif',1)"><img src="{$smarty.const.ROOT_HTTP_PATH}/images/admin_images/bttn_logout.gif" alt="Log Out" name="logout" width="77" height="22" border="0" id="logout" /></a>
                                    {/if}</td>
                                  </tr>
                                </table></td>
                              <td width="10" align="right" valign="top"><img src="{$smarty.const.ROOT_HTTP_PATH}/images/admin_images/topnav_right.gif" alt="" width="10" height="39" /></td>
                            </tr> 
                          </table></td>
                      </tr>
                    </table></td>
